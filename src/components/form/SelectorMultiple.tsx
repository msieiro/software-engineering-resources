                    ...
                    <>
                        ...
                        <div className="relative mt-2 rounded-md bg-primary-content text-primary">
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-primary-content text-primary py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                    {options.map((option) => (
                                        <Listbox.Option
                                            key={option}
                                            className={({ active }) =>
